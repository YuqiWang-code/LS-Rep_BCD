...
class NeighborFeatureAggregation(nn.Module):
    ...
    def forward(self, c2, c3, c4, c5):
        ...
        c3_s2 = F.interpolate(c3_s2, size=c2_s2.shape[-2:], mode='bilinear', align_corners=False)
        ...
        c4_s3 = F.interpolate(c4_s3, size=c3_s3.shape[-2:], mode='bilinear', align_corners=False)
        ...
        c5_s4 = F.interpolate(c5_s4, size=c4_s4.shape[-2:], mode='bilinear', align_corners=False)
