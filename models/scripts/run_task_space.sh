...
dart_data="/share_datasets/CD/${dart_dataset}-CD-256"
dart_sam="/share_datasets/CD_teacher_cache/SAMStruct/sam2.1_hiera_large/${dart_dataset}-CD-256"
dart_ov="/share_datasets/CD_teacher_cache/OVCDistill/dinov2_vitb14/${dart_dataset}-CD-256"
dart_run="${dart_experiment}/${dart_dataset}/steps_${dart_steps}/seed_${dart_seed}"
dart_save="/share_datasets/yqwang/checkpoints/LS-Rep_BCD_RSML_3/DART-R-TS/${dart_run}"
